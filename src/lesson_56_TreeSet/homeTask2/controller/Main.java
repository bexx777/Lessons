package lesson_56_TreeSet.homeTask2.controller;

public class Main {
    public static void main(String[] args) {
//        HashMap<Bar,Integer> barStringHashMap = new HashMap<>();
//        barStringHashMap.put(new Bar<>("Biererei Bar & Vintage Cellar","Horstweg 7, 14059 Berlin",4.4);
//        barStringHashMap.put(new Bar<>("Monkey Bar","Budapester Str. 40, 10787 Berlin"),4.2);
//        barStringHashMap.put(new Bar<>("Gecco Bar Berlin","Rankestraße 3, 10789 Berlin"),4.0);
//        barStringHashMap.put(new Bar<>("Bar Zentral","Lotte-Lenya-Bogen 551, 10623 Berlin"),4.6);
//        barStringHashMap.put(new Bar<>("Heine Bar","Putlitzstraße 19, 10551 Berlin"),4.7);
//        barStringHashMap.put(new Bar<>("Heine Bar","Putlitzstraße 19, 10551 Berlin"),4.7);
//        System.out.println(barStringHashMap.size());
    }
}
